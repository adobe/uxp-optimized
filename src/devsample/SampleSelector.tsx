            ...
            <div style={{ flex: "0 0 auto" }}>
                ...
                <button
                    onClick={() => {
                        ...
                        let bounds = virtualizer.getVisibleRect();
                        console.log(keys);
                        console.log(
                            keys.map((key) => virtualizer.getItemRect(key))
                        );
                        console.log({ bounds });
                    }}
                >
                    Get Render Items and Bounds
                </button>
                {[0, 20, 40, 60, 80, 81, 82, 83, 84, 85].map((headerIndex) => {
                    ...
                    return (
                        ...
                        >
                            ScrollToCell Header {headerIndex}
                        </button>
                    );
                })}
            </div>
...
ReactDOM.render(
    <SampleSelector />,
    document.getElementById("newReactContainer")
);
